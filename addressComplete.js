    ...
    * @mixes Eventable */
    pca.AddressComplete = function () {
        ...
        * @type {Array.<pca.AddressComplete.Bindings>} */
        addresscomplete.bindings = [{ fields: [{ element: "lookup2", field: "{Label}", mode: 1 }, { element: "address2", field: "{Label}", mode: 2 }, { element: "company2", field: "{Company}", mode: 6 }, { element: "line12", field: "{Line1}", mode: 2 }, { element: "line22", field: "{Line2}", mode: 2 }, { element: "city2", field: "{City}", mode: 2 }, { element: "province2", field: "{ProvinceName}", mode: 2 }, { element: "postalcode2", field: "{PostalCode}", mode: 2 }], options: { key: "PW19-GF38-JT12-CJ13", "International_BoundCountry": ""}}, { fields: [{ element: "line13", field: "{Line1}", mode: 3 }, { element: "line23", field: "{Line2}", mode: 2 }, { element: "city3", field: "{City}", mode: 2 }, { element: "province3", field: "{ProvinceName}", mode: 2 }, { element: "postalcode3", field: "{PostalCode}", mode: 2 }], options: { key: "PW19-GF38-JT12-CJ13", "International_BoundCountry": ""}}, { fields: [{ element: "company", field: "{Company}", mode: 6 }, { element: "line1", field: "{Line1}", mode: 2 }, { element: "line2", field: "{Line2}", mode: 2 }, { element: "city", field: "{City}", mode: 2 }, { element: "province", field: "{ProvinceName}", mode: 2 }, { element: "postalcode", field: "{PostalCode}", mode: 2 }, { element: "lookup1", field: "{AddressLabel}", mode: 1 }], options: { key: "PW19-GF38-JT12-CJ13", "International_BoundCountry": ""}}];
